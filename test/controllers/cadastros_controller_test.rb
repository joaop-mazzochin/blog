...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { data: @cadastro.data, hour: @cadastro.hour, name: @cadastro.name, value: @cadastro.value } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { data: @cadastro.data, hour: @cadastro.hour, name: @cadastro.name, value: @cadastro.value } }
